...
object PriceCheck {
    ...
    private val executor = ThreadPoolExecutor(
        ...
        Thread(r, "overwatch-price-check").also { it.isDaemon = true }
    }
    ...
    fun register() {
        ItemTooltipCallback.EVENT.register { stack, _, _, lines ->
            ...
            if (!config.priceCheckEnabled || !OverwatchGate.inGame || stack.isEmpty) return@register
    ...
    private fun fetch(query: Query, apiKey: String) {
        ...
        val result = try {
            ...
            Overwatch.LOGGER.warn("Price check request failed for '{}': {}", query.name, t.toString())
