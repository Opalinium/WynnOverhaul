...
class ContentBookInterceptor : ClientModInitializer {
    override fun onInitializeClient() {
        ...
        ScreenEvents.BEFORE_INIT.register { _, screen, _, _ ->
            ...
            if (!WynnOverhaulConfig.current.contentBookOverrideEnabled) return@register
    ...
    companion object {
        ...
        fun tick(client: Minecraft) {
            ...
            val host = pendingJournalHost ?: WynnOverhaulInventoryScreen(player.inventoryMenu, WynnOverhaulInventoryScreen.InvTab.JOURNAL)
            pendingJournalHost = null
            host.attachJournalMenu(menu)
            if (client.gui.screen() !== host) client.setScreenAndShow(host)
        }

        fun openJournalContainer(client: Minecraft, host: WynnOverhaulInventoryScreen, menuSlot: Int): String? {
