...
object TownNpcTracker {
    ...
    fun tick(client: Minecraft) {
        ...
        if (!config.townNpcMarkersEnabled || !WynnOverhaulGate.inGame || level == null || player == null) {
    ...
    private fun nameOf(entity: Entity): String? {
        ...
        if (entity is Display.TextDisplay) {
            val text = runCatching { (entity as TextDisplayAccessor).`wynnoverhaul$getText`() }.getOrNull()
