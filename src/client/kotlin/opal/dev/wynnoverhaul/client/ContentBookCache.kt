...
object ContentBookCache {
    private val PATH = FabricLoader.getInstance().configDir.resolve("wynnoverhaul-contentbook.json")
    ...
    private fun persist() {
        ...
        try {
            ...
            WynnOverhaul.LOGGER.error("Failed to save content book cache", t)
        }
    }
    ...
    private fun readAll(): MutableMap<String, PersistedEntry> = try {
        ...
        WynnOverhaul.LOGGER.error("wynnoverhaul-contentbook.json unreadable, starting a fresh store", t)
        mutableMapOf()
    }
