...
object XaeroHook {
    ...
    fun tick(client: Minecraft) {
        ...
        try {
            ...
            failed = true
            WynnOverhaul.LOGGER.warn("WynnOverhaul: Xaero's Minimap hook disabled ({})", t.toString())
        }
    }
    ...
    private fun buildApi(): Api? = try {
        ...
        WynnOverhaul.LOGGER.warn("WynnOverhaul: Xaero's Minimap API not found ({})", t.toString())
        null
    }
