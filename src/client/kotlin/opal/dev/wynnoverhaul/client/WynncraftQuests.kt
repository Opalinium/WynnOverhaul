...
object WynncraftQuests {
    ...
    private fun load(): List<Quest> {
        return try {
            val stream = WynncraftQuests::class.java.getResourceAsStream("/assets/wynnoverhaul/quests.json")
                ?: return emptyList()
            ...
            WynnOverhaul.LOGGER.error("Failed to load bundled quest reference data", t)
            emptyList()
        }
    }
}
